...
>(({ className, ...props }, ref) => (
  <SliderPrimitive.Root
    ...
    {...props}
  >
    <SliderPrimitive.Track className="relative h-2 w-full grow overflow-hidden rounded-full bg-[#ffffff] dark:bg-[#ffffff]">
      <SliderPrimitive.Range className="absolute h-full bg-[#0A83FF] dark:bg-[#0A83FF]" />
